...
* address 0..* Reference "Patient address" "Patsiendi aadress"
* telecom 0..* Reference "A contact detail for the person" "Patsiendi kontaktandmed"  
...
* Communication 0..* BackboneElement "A language which may be used to communicate with the patient about his or her health." "Patsiendi eelistatud suhtluskeel."
