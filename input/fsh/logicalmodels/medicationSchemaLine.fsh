...
Title: "MedicationTreatmentLineTJT"
...
* medication 1..1 Reference "Medicinal product for which the treatment line refers to." "Ravim, mis on reaga seotud."
* status 1..1 CD "A code representing the status of recording the medication statement. " "Ravimiskeemi rea staatus. Kinnitatud, kinnitamata."
...
* dosageInstructions 0..* Reference "Instructions about requested administration of the product" "Annustamisjuhis"
...
* comment 0..* Class "Comment on the individual line" "Ravimiskeemi rea kommentaar."
  * author 1..1 Reference "Author of the comment (Pharmacist, doctor, social carer, patient, device, related person)" "Kommentaari autor"
...
* recordingMetadata 1..1 Class "Metadata about reporting/authoring of the treatment line" "Info ravimiskeemi rea koostaja/koostamise kohta."
  * recorder 1..1 Reference "Person authoring/cancelling the treatment line, either by requesting a treatment or documenting a patient's statement. Typically a doctor, nurse, or pharmacist, or patient..." "Isik, kes ravimiskeemi rea koostas, raporteeris infot, tervishoiutöötaja, patsient jne."
