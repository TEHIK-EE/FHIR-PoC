...
* medication 1..* Class "Medicinal product" "Ravim"
  * identifierMedication 1..* Class "Business identifier for this medication." "Ravimi identifikaator."
    * packagedProductIdentifier 0..* II "Identifier at the package level, can be PCID or national" "Pakendi kood näiteks pakendipõhisel retseptil."classification 0..1 Class "Code for the product that is actually being specified, in established terminologies" "Ravimi klassifikatsioon."
...
* prescription 0..* Class "Prescription" "Retsept"  
  ...
  * repeatCategory 0..* CD "Prescriptions to repeat" "Retsepti kordsus, näiteks 1-kordne, 2-kordne, 3-kordne, 6-kordne." * unauthorizedMedicationRequest 0..1 Reference(UnauthorizedMedication) "Requesting usage permit for unauthorized medication." "Müügiloata ravimi taotlus."
