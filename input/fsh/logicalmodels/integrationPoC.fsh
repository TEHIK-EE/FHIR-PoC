...
* metadata 1..1 Class "Metadata about the medication schema" "Ravimiskeemi metaandmestik"
  ...
  * publisher 0..* ST "Publisher of the model" "Mudeli publitseerija"
  * contact 0..* Class "Contact information" "Kontaktandmed"
    * name 0..* ST "Publisher's official name" "Publitseerija ametlik nimi"
    * telecom 0..* Class "Telecom" "võimalused kontakteerumiseks"
      * system 0..1 CD "System" "Süsteem"
      * value 0..1 ST "Value" "Süsteemi väärtus"
  * juristiction 0..* CD "Juristiction" "Juristiction"
  * lastUpdated 0..1 DT "Last updated" "Viimati uuendatud"
  * treatmentLineRecordingMetaData 1..1 Class "Metadata about reporting/authoring of the treatment line" "Metaandmed ravimiskeemi rea koostamise kohta"
...
* medicationOverview 0..* Class "Overview of the medication in the medication schema" "ravimi ülevaade ravimiskeemis"
...
* medication 1..* Class "Medicinal product" "Ravim"
  ...
  * patientPersonalMedication 0..1 BL "Whether the medication was patient's own or given by a healthcare professional." "Tõeväärtus, mis näitab, kas manustatav ravim on patsiendi isiklik või antud ühekordsena tervishoiu töötaja poolt - Kiirabikaardil manustatud ravimite sektsioonis" 
