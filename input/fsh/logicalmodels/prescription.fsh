...
* prescriptionAuthorization 0..* CD "Defines the authorization of the prescription." "Retsepti volituse liik avalik, privaatne, volitatud."
...
* substitution 0..1 Class "Whether and which type of substitution is allowed for this medication" "Ravimi asendamatus ja mis põhjusel"
