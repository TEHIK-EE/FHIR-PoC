...
* reimbursement 1..1 Class "For representation of the reimbursement rate and reason of prescription medicine." "Retsepti soodustus ja põhjus."
  * reimbursementRate 1..1 CD "Reimbursement of medication." "Retsepti soodustuse määr. Retseptikeskuse loendist Soodustuste määrad, näiteks 0, 50, 75, 90, 100 protsenti."
