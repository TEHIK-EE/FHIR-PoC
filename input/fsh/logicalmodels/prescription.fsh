...
* note 0..1 ANY "Extra information about the prescription that could not be conveyed by the other attributes." "Retseptikoostaja kommentaar"
...
* repeatCategory 0..* CD "Prescriptions to repeat" "1-kordne | 2-kordne | 3-kordne | 6-kordne" *MarketingRequest 0..1 Reference "Requesting marketing permit for unauthorized medication." "Müügiloata ravimi taotlus"
* reimbursement 0..1 Class
  * reimbursementRate 0..* CD "Soodustuste määr"
  * reimbursementReason 0..* CD "Soodusravimite loetelule vastav tingimus"
