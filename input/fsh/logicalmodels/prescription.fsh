...
* reason 1..1 CD "Reason or indication for ordering the medication." "Retsepti koostamise põhjus. Diagnoos"
...
* courseOfTherapyType 0..* CD "Type of therapy" "Ravikuuri tüüp pidev, fikseeritud, vajadusel, muutuv, ühekordne "
...
* prescribedAmount 0..* INT "How much in total there is medication prescribed on prescription." "Kui palju on ravimit koguseliselt välja kirutatud näiteks 120 tabletti. Väljakirjutatud kogus."
* prescriptionValidityTime 0..* DT "For expressing the validity of the prescription(s)." "Retsepti kehtivuse aeg."
* prescriptionAuthorization 0..* CD "Defines the authorization of the prescription." "Volituse liik avalik, privaatne, volitatud."
...
* substitution 0..1 Class "Whether and which type of substitution is allowed for this medication" "Ravimi asendamine ja mis põhjusel"
...
* reimbursement 1..1 Class "For representation of the reimbursement rate and reason of prescription medicine."
  * reimbursementRate 1..1 CD "Shows the reimbursement rate of medication." "Retsepti soodustuse määr, näiteks 0, 50, 75, 90, 100 protsenti."
  * reimbursementReason 1..1 ST "Reason of the reimbursement rate." "soodustuse määra põhjus."
