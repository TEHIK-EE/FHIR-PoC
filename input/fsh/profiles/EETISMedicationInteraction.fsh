...
* category[sliceClinicalImportance] from $clinical-importance-category (required)
...
* category[sliceScientificDocumentation] from $scientific-documentation-category (required)
